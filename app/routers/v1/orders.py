...
"""
GoldenTales Orders Router (API v1)
==================================
API v1 endpoints for order management and pricing.
"""
...
from app.routers.v1.books import get_book_storage
...
async def create_order(
    ...
    shipping_opts = get_shipping_options()
    shipping_option = next(
        (o for o in shipping_opts if o['tier'] == request.shipping_tier.value),
        shipping_opts[0]
    )
