# alembic/env.py
"""
Alembic Environment Configuration for GoldenTales
==================================================
This file is run whenever alembic migrations are invoked.
"""
...
# For now, we'll use manual migrations
# In the future, if you add SQLAlchemy models, import them here
